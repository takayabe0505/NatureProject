...
//	static File shapedir = new File("/home/t-tyabe/NatureExp/KanazawaSHP");
	...
	public static void extractfromcommand(String date){
		...
		File out2 =   new File("/home/t-tyabe/Data/grid/0/tmp/hadoop-ktsubouc/data_"+date);
		out2.renameTo(new File("/home/t-tyabe/Data/grid/0/tmp/hadoop-ktsubouc/data_"+date+".csv"));
	}
